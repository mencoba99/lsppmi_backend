                            ...
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                                <?php echo Form::select('element',$element,null,['id'=>'element','class'=>'form-control input-sm kt-selectpicker','required'=>'required','data-live-search'=>"true",'placeholder'=>'Pilih Element']); ?>
...
jQuery(document).ready(function() {
    ...
    form = $("#form").validate({
        ...
        messages: {
            "name": {
                required: "Silahkan tulis nama kuk yang akan diinput"
            },
            "code": {
                required: "Silahkan tulis kode kuk"
            },
            "element": {
                required: "Silahkan pilih element"
            },
            "status": {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo e(route('master.kuk.insert')); ?>",
            dataType:"json",
            data: {
                name: $("#name").val(),
                id: $("#id").val(),
  ...
  function view(){
    ...
    $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('master.kuk.data')); ?>",
            columns: [
    ...
    $(function() {
        ...
        $("#datatable").on("click", "tr #edit", function() { 
            ...
            $("select#element").val($(this).data('element'));
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/master/kuk.blade.php ENDPATH**/ ?>