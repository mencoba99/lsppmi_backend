                            ...
                            <div class="kt-widget4__items kt-widget4__items--bottom kt-portlet__space-x kt-margin-b-20">
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__img kt-widget4__img--logo">
                                        <img src="<?php echo e(Storage::url('media/client-logos/logo3.png')); ?>" alt="">
                                    </div>
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__img kt-widget4__img--logo">
                                        <img src="<?php echo e(Storage::url('media/client-logos/logo1.png')); ?>" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__title">
                                            FlyThemes
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__img kt-widget4__img--logo">
                                        <img src="<?php echo e(Storage::url('media/client-logos/logo2.png')); ?>" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__title">
                                            AirApp
                        ...
                        <div class="kt-widget4">
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--icon">
                                    <img src="<?php echo e(Storage::url('media/files/doc.svg')); ?>" alt="">
                                </div>
                                <a href="#" class="kt-widget4__title">
                            ...
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--icon">
                                    <img src="<?php echo e(Storage::url('media/files/jpg.svg')); ?>" alt="">
                                </div>
                                <a href="#" class="kt-widget4__title">
                            ...
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--icon">
                                    <img src="<?php echo e(Storage::url('media/files/pdf.svg')); ?>" alt="">
                                </div>
                                <a href="#" class="kt-widget4__title">
                            ...
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--icon">
                                    <img src="<?php echo e(Storage::url('media/files/javascript.svg')); ?>" alt="">
                                </div>
                                <a href="#" class="kt-widget4__title">
                                    Make JS Great Again
                                </a>
                            ...
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--icon">
                                    <img src="<?php echo e(Storage::url('media/files/zip.svg')); ?>" alt="">
                                </div>
                                <a href="#" class="kt-widget4__title">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="kt-widget4">
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_4.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_14.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Milano Esco
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_11.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Nick Bold
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_1.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Wiltor Delton
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_5.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Nick Stone
                            ...
                            <div class="tab-pane" id="kt_widget4_tab2_content">
                                <div class="kt-widget4">
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_2.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Kristika Bold
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_13.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Ron Silk
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_9.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Nick Bold
                                    ...
                                    <div class="kt-widget4__item">
                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                            <img src="<?php echo e(Storage::url('media/users/100_8.jpg')); ?>" alt="">
                                        </div>
                                        <div class="kt-widget4__info">
                                            <a href="#" class="kt-widget4__username">
                                                Nick Bold
                            ...
                            <div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
                                <div class="kt-widget5">
                                    <div class="kt-widget5__item">
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__pic">
                                                <img class="kt-widget7__img" src="<?php echo e(Storage::url('media/products/product27.jpg')); ?>" alt="">
                                            </div>
                                    ...
                                    <div class="kt-widget5__item">
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__pic">
                                                <img class="kt-widget7__img" src="<?php echo e(Storage::url('media/products/product22.jpg')); ?>" alt="">
                                            </div>
                                            <div class="kt-widget5__section">
                                                <a href="#" class="kt-widget5__title">
                                                    Branding Mockup
                                    ...
                                    <div class="kt-widget5__item">
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__pic">
                                                <img class="kt-widget7__img" src="<?php echo e(Storage::url('media/products/product15.jpg')); ?>" alt="">
                                            </div>
                                            <div class="kt-widget5__section">
                                                <a href="#" class="kt-widget5__title">
                                                    Awesome Mobile App
                            ...
                            <div class="tab-pane" id="kt_widget5_tab2_content">
                                <div class="kt-widget5">
                                    <div class="kt-widget5__item">
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__pic">
                                                <img class="kt-widget7__img" src="<?php echo e(Storage::url('media/products/product10.jpg')); ?>" alt="">
                                            </div>
                                            <div class="kt-widget5__section">
                                                <a href="#" class="kt-widget5__title">
                                                    Branding Mockup
                                    ...
                                    <div class="kt-widget5__item">
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__pic">
                                                <img class="kt-widget7__img" src="<?php echo e(Storage::url('media/products/product11.jpg')); ?>" alt="">
                                            </div>
                                            <div class="kt-widget5__section">
                                                <a href="#" class="kt-widget5__title">
                                                    Awesome Mobile App
                                    ...
                                    <div class="kt-widget5__item">
                                        <div class="kt-widget5__content">
                                            <div class="kt-widget5__pic">
                                                <img class="kt-widget7__img" src="<?php echo e(Storage::url('media/products/product6.jpg')); ?>" alt="">
                                            </div>
                                            <div class="kt-widget5__section">
                                                <a href="#" class="kt-widget5__title">
                                                    Great Logo Designn
                        ...
                        <div class="kt-widget4">
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--logo">
                                    <img src="<?php echo e(Storage::url('media/client-logos/logo5.png')); ?>" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="#" class="kt-widget4__title">
                                        Trump Themes
                            ...
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--logo">
                                    <img src="<?php echo e(Storage::url('media/client-logos/logo4.png')); ?>" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="#" class="kt-widget4__title">
                                        StarBucks
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/dashboard.blade.php ENDPATH**/ ?>