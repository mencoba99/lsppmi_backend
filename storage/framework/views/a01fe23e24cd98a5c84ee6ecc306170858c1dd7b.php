            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <a href="<?php echo e(route('permission.create')); ?>" class="btn btn-brand btn-icon-sm">
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(Storage::url('vendors/custom/datatables/datatables.bundle.js')); ?>" type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $('#kt_table_1').DataTable({
                ...
                ajax: {
                    'url': '<?php echo e(route('permission.getdata')); ?>',
                    'type': 'POST',
                    'headers': {
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/PengaturanAplikasi/PermissionController/index.blade.php ENDPATH**/ ?>