                                ...
                                <div class="kt-section kt-section--first">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                    <?php echo Form::select('unit',$unit,null,['id'=>'unit','class'=>'form-control input-sm kt-selectpicker','required'=>'required','data-live-search'=>"true",'placeholder'=>'Pilih Unit']); ?>
...
jQuery(document).ready(function() {
    ...
    form = $("#form").validate({
        ...
        $.ajax({
            type: "post",
            url: "<?php echo e(route('master.element.insert')); ?>",
            dataType:"json",
            data: {
                name: $("#name").val(),
                id: $("#id").val(),
  ...
  function view(){
    ...
    $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('master.element.data')); ?>",
            columns: [
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/master/Element.blade.php ENDPATH**/ ?>