<?php $__env->startSection('content'); ?>
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="#" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" title="Tanggal hari ini" data-placement="left">
                    ...
                    <span class="kt-subheader__btn-daterange-date" id="kt_dashboard_daterangepicker_date"><?php echo date('D, d F'); ?></span>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        Manajemen Role <small>Tambah Role</small>
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <a href="<?php echo e(route('role.index')); ?>" class="btn btn-clean btn-icon-sm">
            ...
            <?php echo $__env->make('PengaturanAplikasi.RoleController.form', ['button' => 'Ubah','action'=>route('role.update',['role'=>$role])], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/PengaturanAplikasi/RoleController/edit.blade.php ENDPATH**/ ?>