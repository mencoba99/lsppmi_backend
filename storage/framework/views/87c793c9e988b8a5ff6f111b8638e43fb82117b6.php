  ...
  function view(){
    ...
    form = $("#form").validate({
        ...
        submitHandler: function (form) { // for demo
            ...
            $.ajax({
            type: "post",
            url: "<?php echo e(route('master.provinsi.insert')); ?>",
            dataType:"json",
            data: {
    ...
    $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('master.provinsi.data')); ?>",
            columns: [
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/master/provinsi.blade.php ENDPATH**/ ?>