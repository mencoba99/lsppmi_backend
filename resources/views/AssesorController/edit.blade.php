          ...
          <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
              <h3 class="kt-portlet__head-title">
                <i class="flaticon2-plus"></i> Edit Assesor
              </h3>
            </div>
          </div>
          <!--begin::Form-->
          {!! Form::open(['url' => route('assesor.update', $assesor->id), 'method' => 'put', 'class' => 'kt-form kt-form--fit kt-form--label-right', 'files'=> true]) !!}
            <div class="kt-portlet__body">
              <div class="form-group row">
                ...
                <div class="col-lg-3">
                  <input type="text" name="nama" value="{{ $assesor->name }}" class="form-control" placeholder="" autocomplete="off">
                  @if ($errors->has('nama'))
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-3">
                <input type="email" name="email" value="{{ $assesor->email }}" class="form-control" placeholder="" autocomplete="off">
                  @if ($errors->has('email'))
                      <div class="text-danger">
                        {{ $errors->first('email') }}
                      </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-3">
                <input type="text" name="telepon" value="{{ $assesor->telephone }}" class="form-control" placeholder="">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-3">
                <input type="text" name="institusi" value="{{ $assesor->institution }}" class="form-control" placeholder="">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-2 col-form-label">Jabatan</label>
                <div class="col-lg-3">
                <input type="text" name="jabatan" value="{{ $assesor->position }}" class="form-control" placeholder="">
                </div>
              </div>
              <div class="form-group row">
