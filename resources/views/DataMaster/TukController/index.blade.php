            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        @can('Tempat Uji Kompetensi (TUK) Add')
                            <a href="{{ route('tuk.create') }}" class="btn btn-brand btn-icon-sm">
                                <i class="flaticon2-plus"></i> Tambah TUK
                            </a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#kt_table_1').DataTable({
                ...
                columns: [
                    {data: 'name', name: 'name', title: 'Nama TUK'},
                    {data: 'address', name: 'address', title: 'Alamat TUK'},
                    {data: 'province_id', name: 'province_id', title: 'Provinsi'},
                    {data: 'regency_id', name: 'regency_id', title: 'Kabupaten/Kota'},
