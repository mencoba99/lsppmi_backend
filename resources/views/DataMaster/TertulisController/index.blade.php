            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        @can('Pertanyaan Tertulis Add')
                            <a href="{{ route('tertulis.create') }}" class="btn btn-brand btn-icon-sm">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#kt_table_1').DataTable({
                ...
                columns: [
                    {data: 'unit_id', name: 'unit_id', title: 'Unit'},
                    {data: 'element_id', name: 'element_id', title: 'Element'},
                    {data: 'kuk_id', name: 'kuk_id', title: 'KUK'},
                    {data: 'tuk_id', name: 'tuk_id', title: 'TUK'},
                    {data: 'pertanyaan', name: 'pertanyaan', title: 'Pertanyaan'},
                    {data: 'jawaban', name: 'jawaban', title: 'Jawaban'},
