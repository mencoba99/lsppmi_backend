                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        @can('Unit Kompetensi Add')
                            <a href="{{ route('unit-kompetensi.create') }}" class="btn btn-brand btn-icon-sm">
                                <i class="flaticon2-plus"></i> Tambah Unit Kompetensi
                            </a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#kt_table_1').DataTable({
                ...
                ajax: {
                    'url': '{{ route('unit-kompetensi.getdata') }}',
                    'type': 'POST',
                    'headers': {
                ...
                columns: [
                    {data: 'code', name: 'code', title: 'Kode Unit'},
