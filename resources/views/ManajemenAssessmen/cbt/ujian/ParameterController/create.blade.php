                ...
                <div class="kt-portlet__body">
                    <div class="kt-section kt-section--first">
                        <div class="kt-section__body">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label"> Durasi Masa Aktif Ujian:</label>
                                <div class="col-lg-6">
                                            <div class="input-group pull-right">
                                                {!! Form::number('durasi_masa_aktif_ujian',null,['id'=>'durasi_masa_aktif_ujian','class'=>'form-control'])!!}
                            ...
                            <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">  Durasi Default Ujian:</label>
                                    <div class="col-lg-6">
                                                <div class="input-group pull-right" >
                                                    {!! Form::number('durasi_default_ujian',null,['id'=>'durasi_default_ujian','class'=>'form-control'])!!}
                                                    <div class="input-group-append">
...
jQuery(document).ready(function() {
    ...
    form = $("#form").validate({
        ...
        submitHandler: function (form) { // for demo
                ...
                $.ajax({
                type: "post",
                url: "{{ route('ujian.parameter.insert') }}",
                dataType:"json",
                data: {
                    name: $("#name").val(),
                    durasi_masa_aktif_ujian: $("#durasi_masa_aktif_ujian").val(),
                    durasi_default_ujian: $("#durasi_default_ujian").val(),
