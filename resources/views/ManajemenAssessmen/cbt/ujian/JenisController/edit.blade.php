                    ...
                    <div class="kt-section kt-section--first">
                        <div class="kt-section__body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    {!! Form::text('name',$jenis_ujian->name,['id'=>'name','class'=>'form-control'])!!}
                                    {!! Form::text('user_jenis_id',$jenis_ujian->ujian_jenis_id,['id'=>'user_jenis_id','class'=>'form-control','hidden'=>'hidden'])!!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">Keterangan:</label>
                                <div class="col-lg-6">
                                    {!! Form::textarea('keterangan',$jenis_ujian->keterangan,['id'=>'keterangan','class'=>'form-control ','required'=>'required']) !!}
                                        ...
                                        <div class="kt-portlet__head-toolbar">
                                                <div class="kt-portlet__head-actions">
                                                    <span class="kt-switch kt-switch--icon">
                                                        <label>
                                                            <input type="checkbox" {!! ($jenis_ujian->aktif==true) ? 'checked':'' !!} data-url="" name="aktif" id="aktif" class="roleParentChange roleList">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
...
jQuery(document).ready(function() {
    ...
    form = $("#form").validate({
        ...
        submitHandler: function (form) { // for demo
                ...
                $.ajax({
                type: "post",
                url: "{{ route('ujian.jenis.update') }}",
                dataType:"json",
                data: {
                    name: $("#name").val(),
                    keterangan: $("#keterangan").val(),
                    aktif: $("#aktif").val(),
                    ujian_jenis_id: $("#user_jenis_id").val()
                },
                beforeSend: function() {
                    KTApp.block('.kt-portlet--mobile', {
                    overlayColor: '#000000',
                    type: 'v2',
                    state: 'primary',
                    message: 'Processing...'
                ...
                success: function (response) {
                        ...
                        if (response.status === 200) {
                            ...
                            $.when(setTimeout(function () {
                                KTApp.unblock('.kt-portlet--mobile');
