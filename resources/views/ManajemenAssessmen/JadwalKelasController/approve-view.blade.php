            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered" cellpadding="4">
                    ...
                    @canany(['Jadwal Kelas Approve'])
                        @if ($jadwalKelas->is_approve == 0)
                            <tr>
                                <td colspan="3" align="center" style="padding: 8px;">
                                    <a href="{{ route('jadwal-kelas.approve.set-approve',['jadwal_kelas'=>$jadwalKelas,'status'=>'approve']) }}" class="btn btn-success approveJadwal">Approve Kelas</a>
                                </td>
                            </tr>
                        @else
                            <tr>
                                <td colspan="3" align="center" style="padding: 8px;">
                                    <a href="{{ route('jadwal-kelas.approve.set-approve',['jadwal_kelas'=>$jadwalKelas,'status'=>'unapprove']) }}" class="btn btn-danger unapproveJadwal">Batalkan Approve Kelas</a>
                                </td>
                            </tr>
                        @endif
                    @endcanany
        ...
        $(document).ready(function () {
            ...
            $('body').on('click','.approveJadwal', function (e) {
                ...
                swal.fire({
                    ...
                    text: 'Apakah Anda yakin untuk Approve Jadwal ini?',
                    type: 'warning',
                    allowOutsideClick: true,
                    showConfirmButton: true,
                    showCancelButton: true,
            ...
            $('body').on('click','.unapproveJadwal', function (e) {
                ...
                swal.fire({
                    ...
                    text: 'Apakah Anda yakin untuk membatalkan Approve Jadwal ini?',
                    type: 'warning',
                    allowOutsideClick: true,
                    showConfirmButton: true,
                    showCancelButton: true,
