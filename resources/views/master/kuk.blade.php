                            ...
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                                {!! Form::select('element',$element,null,['id'=>'element','class'=>'form-control input-sm kt-selectpicker','required'=>'required','data-live-search'=>"true",'placeholder'=>'Pilih Element']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
