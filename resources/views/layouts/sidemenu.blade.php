...
<!-- begin:: Brand -->
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        ...
        <ul class="kt-menu__nav ">
                    ...
                    <div class="kt-menu__wrapper">
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('cbt', $prefix) ? 'kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-event-calendar-symbol"><span></span></i><span class="kt-menu__link-text">Pendaftaran</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item {{ ($routeName == 'peserta.pendaftaran') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('peserta.pendaftaran') }}" class="kt-menu__link "><span class="kt-menu__link-text">Peserta</span></a></li>
                                        <li class="kt-menu__item {{ ($routeName == 'peserta.pendaftaran.sertifikasi') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('peserta.pendaftaran.sertifikasi') }}" class="kt-menu__link "><span class="kt-menu__link-text">Sertifikasi</span></a></li>
                                        <li class="kt-menu__item {{ ($routeName == 'peserta.pendaftaran.sertifikasi.pembayaran') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('peserta.pendaftaran.sertifikasi.pembayaran') }}" class="kt-menu__link "><span class="kt-menu__link-text">Pembayaran</span></a></li>
                                        <li class="kt-menu__item {{ ($routeName == 'pendaftaran.pemilihanasesor') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('pendaftaran.pemilihanasesor') }}" class="kt-menu__link "><span class="kt-menu__link-text">Pemilihan Asesor</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('manajemen-kelas', $prefix) ? 'kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Manajemen Kelas</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @endcan
                                        @can('Unit Kompetensi')
                                                <li class="kt-menu__item {{ ($routeName == 'master.units') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.units') }}" class="kt-menu__link "><span class="kt-menu__link-text">Unit Kompetensi</span></a></li>
                                        @endcan
                                        @can('Elemen Kompetensi')
                                                <li class="kt-menu__item {{ ($routeName == 'master.element') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.element') }}" class="kt-menu__link "><span class="kt-menu__link-text">Elemen Kompetensi</span></a></li>
                                        @endcan
                                        @can('Kerangka Unjuk Kerja')
                                                <li class="kt-menu__item {{ ($routeName == 'master.kuk') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.kuk') }}" class="kt-menu__link "><span class="kt-menu__link-text">Kriteria Unjuk Kerja</span></a></li>
                                        @endcan
            ...
            @endcanany
            <li class="kt-menu__item  kt-menu__item--submenu  kt-menu__item--submenu-fullheight" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-dropdown-toggle-class="kt-aside-menu-overlay--on"><a target="_blank" href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon2-analytics-2"></i><span class="kt-menu__link-text">Manajemen Ujian CBT</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                    <div class="kt-menu__wrapper">
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('cbt', $prefix) ? 'kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-event-calendar-symbol"><span></span></i><span class="kt-menu__link-text">Manajemen Program</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('cbt', $prefix) ? 'kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-imac"><span></span></i><span class="kt-menu__link-text">Program</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                                <ul class="kt-menu__subnav">
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian-komputer.kategori') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian-komputer.kategori') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Kategori</span></a></li>
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian-komputer.program') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian-komputer.program') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Program</span></a></li>
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian-komputer.management') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian-komputer.management') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Management</span></a></li>
                                        ...
                                        <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('cbt', $prefix) ? 'kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-imac"><span></span></i><span class="kt-menu__link-text">Ujian Komputer</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                                <ul class="kt-menu__subnav">
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian.jenis') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian.jenis') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Jenis</span></a></li>
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian.jadwal') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian.jadwal') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Jadwal</span></a></li>
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian.parameter') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian.parameter') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Parameter</span></a></li>
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian.aktivasi') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian.aktivasi') }}" class="kt-menu__link " style="padding-left: 20px !important;"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Aktivasi</span></a></li>
                                                    {{--  <li class="kt-menu__item {{ ($routeName == 'ujian.aktivasi') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian.aktivasi') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Result</span></a></li>
                                                    <li class="kt-menu__item {{ ($routeName == 'ujian.aktivasi') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('ujian.aktivasi') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">History</span></a></li>  --}}
                ...
                <li class="kt-menu__item  kt-menu__item--submenu  kt-menu__item--submenu-fullheight {{ in_array('management-assesmen', $prefix) ? 'kt-menu__item--open kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-dropdown-toggle-class="kt-aside-menu-overlay--on"><a target="_blank" href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-customer"></i><span class="kt-menu__link-text">Manajemen Asesmen</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <div class="kt-menu__wrapper">
                            <ul class="kt-menu__subnav">
                                <li class="kt-menu__item  kt-menu__item--parent kt-menu__item--submenu-fullheight" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Manajemen Asesmen</span></span></li>
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('manajemen-kelas', $prefix) ? ' kt-menu__item--open kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-event-calendar-symbol"><span></span></i><span class="kt-menu__link-text">Manajemen Kelas</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                        <ul class="kt-menu__subnav">
                                            @can('Jadwal Kelas')
                                            ...
                                            @endcan
                                            @can('Jadwal Kelas Publish')
                                                <li class="kt-menu__item {{ ($routeName == 'jadwal-kelas.publish.index') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('jadwal-kelas.publish.index') }}" class="kt-menu__link "><span class="kt-menu__link-text">Publish Jadwal Kelas</span></a></li>
                                            @endcan
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('manajemen-assessmen', $prefix) ? ' kt-menu__item--open kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-customer"><span></span></i><span class="kt-menu__link-text">Manajemen Assessmen</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                        <ul class="kt-menu__subnav">
