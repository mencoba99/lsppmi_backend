                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open {{ in_array('manajemen-kelas', $prefix) ? 'kt-menu__item--here':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-submenu-mode="accordion"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Manajemen Kelas</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('Assessor')
                                            <li class="kt-menu__item {{ ($routeName == 'assessor.index') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('assessor.index') }}" class="kt-menu__link " style="padding-left: 20px !important;"><span class="kt-menu__link-text">Assessor</span></a></li>
                                        @endcan
                                        @can('Tempat Uji Kompetensi (TUK)')
                                            <li class="kt-menu__item {{ ($routeName == 'tuk.index') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('tuk.index') }}" class="kt-menu__link " style="padding-left: 20px !important;"><span class="kt-menu__link-text">TUK</span></a></li>
                                        @endcan
                                        @can('Provinsi')
                                            <li class="kt-menu__item {{ ($routeName == 'master.provinsi') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.provinsi') }}" class="kt-menu__link " style="padding-left: 20px !important;"><span class="kt-menu__link-text">Provinsi</span></a></li>
                                        @endcan
                                        @can('Kota')
                                            <li class="kt-menu__item {{ ($routeName == 'master.kota') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.kota') }}" class="kt-menu__link " style="padding-left: 20px !important;"><span class="kt-menu__link-text">Kabupaten/Kota</span></a></li>
                                        @endcan
                                        @can('Unit Kompetensi')
                                                <li class="kt-menu__item {{ ($routeName == 'master.units') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.units') }}" class="kt-menu__link " style="padding-left: 20px !important;"><span class="kt-menu__link-text">Unit Kompetensi</span></a></li>
                                        @endcan
                                        @can('Elemen Kompetensi')
                                                <li class="kt-menu__item {{ ($routeName == 'master.element') ? 'kt-menu__item--active':'' }}" aria-haspopup="true"><a href="{{ route('master.element') }}" class="kt-menu__link " style="padding-left: 20px !important;"><span class="kt-menu__link-text">Elemen Kompetensi</span></a></li>
                                        @endcan
