                    ...
                    <div class="kt-header__topbar-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                            <form>
                                ...
                                <!-- begin:: Mycart -->
                                <div class="kt-mycart">
                                    <div class="kt-mycart__head kt-head" style="background-image: url({{ Storage::url('media/misc/bg-1.jpg') }});">
                                        ...
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ Storage::url('media/products/product9.jpg') }}" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ Storage::url('media/products/product13.jpg') }}" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ Storage::url('media/products/product16.jpg') }}" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ Storage::url('media/products/product15.jpg') }}" title="" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon kt-header__topbar-icon--brand">
										<img class="" src="{{ Storage::url('media/flags/012-uk.svg') }}" alt="" />
									</span>
                        </div>
                            ...
                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                <li class="kt-nav__item kt-nav__item--active">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="{{ Storage::url('media/flags/020-flag.svg') }}" alt="" /></span>
                                        <span class="kt-nav__link-text">English</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="{{ Storage::url('media/flags/016-spain.svg') }}" alt="" /></span>
                                        <span class="kt-nav__link-text">Spanish</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="{{ Storage::url('media/flags/017-germany.svg') }}" alt="" /></span>
