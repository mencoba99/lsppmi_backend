...
<div class="kt-portlet__body">
    {!! Form::open(['url'=>$action,'id'=>'form-role','method'=>(!empty($permission) ? 'PUT':'POST')]) !!}
    <div class="row">
            ...
            <div class="kt-section kt-section--first">
                <div class="kt-section__body">
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            {!! Form::select('parent_id', $permissionList, (is_object($permission) ? $permission->parent_id:null),['class'=>'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-form-label">Nama Role</label>
                        <div class="col-9">
                            {!! Form::text('name',(!empty($permission) ? $permission->name:null),['class'=>'form-control','placeholder'=>'Nama Permission']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
